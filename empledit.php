					...
					<tr> <td> <input type="hidden" name="id" value="<?php echo $id; ?>"> </tr>
						...
						<div class="form-group">
							<div class="row">
								...
								<input class="form-control" type="text" name="empno" value="<?php echo $empno; ?>"></input>	
							</div>
						</div>
						...
						<div class="form-group">
							<div class="row">
								...
								<input class="form-control" type="text" name="empname" value="<?php echo $empname; ?>"></input>	
							</div>
						</div>
						...
						<div class="form-group">
							<div class="row">
								...
								<input class="form-control" type="date" id="start" name="trip-start" value="<?php echo $tripstart; ?>"></input>	
							</div>
						</div>
						...
						<div class="form-group">
							<div class="row">
								...
								<div class="form-check form-check-inline ml-5">
  									<input class="form-check-input" type="radio" name="inlineRadioOptions"  value="<?php echo $inlineRadioOptions; ?>">
						...
						<div class="form-group">
							<div class="row">
								...
								<input class="form-control" type="text" name="evename" value="<?php echo $evename; ?>"></input>	
							</div>
						</div>
