...
<div class="jumbotron jumbotron-fluid">
	<div class="card offset-sm-1 col-sm-11">
			<div class="card-body">
...
<td><font face="Arial, Helvetica, sans-serif"><a href="<?php echo $web;?>">
<?php echo $row['adviser'];?></font></td>
<td><font face="Arial, Helvetica, sans-serif"><a href="studentedit.php?id=<?php echo $row['id'] ?>">
Edit <br> <a href="studentdelete.php?id=<?php echo $row['id'] ?>">Delete</font></td>
</tr>
